...
const SignUpPage = () => {
  ...
  // List of interests
  const allInterests = [
    'Music', 'Art', 'Poetry', 'Dance', 'Photography', 'Cooking', 'Reading', 
    'Writing', 'Traveling', 'Technology', 'Gaming', 'Fitness', 'Movies', 
    'Yoga', 'Nature', 'Sports', 'Fashion', 'Animals', 'Science', 'Theater'
  ];
